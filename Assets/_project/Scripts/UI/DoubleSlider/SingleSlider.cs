...
namespace TS.DoubleSlider
{
    ...
    public class SingleSlider : MonoBehaviour, ISingleSlider
    {
        #region Variables
        ...
        public void Setup(float value, float minValue, float maxValue, UnityAction<float> valueChanged, DateTime earlisetDate)
        {
            Setup(value, minValue, maxValue, valueChanged);
        }
